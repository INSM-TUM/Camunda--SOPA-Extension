...
export declare class IpcClient implements protocol.Client {
    ...
    calculate(setup: o.CalculationSetup): Promise<IpcResult>;
    simulate(setup: o.CalculationSetup): Promise<IpcResult>;
    _callEach<T>(method: string, params: Dict, fn: (resp: any) => T | null): Promise<protocol.Response<T[]>>;
    _call<T>(method: string, params: Dict, fn: (resp: any) => T | null): Promise<protocol.Response<T>>;
}
export declare class IpcResult implements protocol.Result {
    private readonly client;
    private readonly id;
    private error?;
    constructor(client: IpcClient, state: o.ResultState);
